...
def create_prompt_for_skill(skill_key_en):
    ...
    """
    # Hints can be added if needed, but keep the main instruction clear
    # Example hint structure (optional):
    # hints_ar = {
    #     "Jumping": "تلميح المعيار: ركز على لمسات الركبة المتحكم بها أثناء الطيران.",
    #     "Running": "تلميح المعيار: ركز على إبقاء الكرة قريبة أثناء الحركة السريعة.",
    # }
    # prompt = base_instruction + "\n" + hints_ar.get(skill_key_en, "")
